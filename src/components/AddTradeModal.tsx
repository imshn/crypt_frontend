...
export function AddTradeModal({ isOpen, onClose, portfolioId }: AddTradeModalProps) {
    ...
    }, [searchQuery, searchCoins, coinId]);
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            toast.success(`${type} Order Executed`, {
                description: `${quantity} ${symbol} @ $${parseFloat(price).toLocaleString()}`
            });
        ...
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="sm:max-w-[425px]">
                ...
                <form onSubmit={handleSubmit} className="grid gap-4 py-4">
                    ...
                    <div className="grid gap-2">
                        ...
                        {feeType === "PERCENTAGE" && fee && tradeValue > 0 && (
                            <p className="text-xs text-muted-foreground">
                                = ${feeAmount.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })} fee on ${tradeValue.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })} trade
                            </p>
                        )}
                    </div>
                    ...
                    <DialogFooter>
                        <Button type="submit" disabled={loading} className={type === 'BUY' ? "w-full bg-green-600 hover:bg-green-700" : "w-full bg-red-600 hover:bg-red-700"}>
